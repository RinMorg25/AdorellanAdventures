...
export function createWorld() {
    ...
    const roomData = {
        ...
        'windingPassage': { name: 'Winding Passage', description: 'Beyond the door is a long, winding passage carved from the rock. It slopes gently downwards and ends at another door. You try the door but it is locked, you notice a small dragon carved in to the center of the door.' },
    ...
    const connectionData = [
        ...
        { from: 'temple', to: 'windingPassage', direction: 'back', returnDirection: 'forward', locked: 'white_king' },
    ];
    ...
    return {
        ...
        rooms: rooms,
        gameItems: gameItems // Export all created items
    };
}